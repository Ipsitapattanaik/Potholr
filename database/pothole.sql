...
INSERT INTO app_user (user_id,user_name, password) VALUES (1,'ipp', 'ipp');
INSERT INTO app_user (user_id,user_name, password, is_employee) VALUES (2,'Employee', 'employee', true);
INSERT INTO app_user (user_id,user_name, password, is_employee) VALUES (3,'kell', 'kell', true);

INSERT INTO pothole(pothole_Id,user_id, street_Name, street_Number, zip_Code, state, city, country, status_Date, status_Code, lat, lng, severity, report_Date,report_User, img_Url) VALUES (1,1, 'Pennsylvania',901, 15233, 'PA','Pittsburgh', 'USA', '10/15/2018', 'Inspected', 40.456257, -80.0189, 2, '10/12/2018', 'Kaelin', 'https://i.imgflip.com/2537yf.jpg' );
...
INSERT INTO pothole(pothole_Id, user_id, street_Name, street_Number, zip_Code, state, city, country, status_Date, status_Code, lat, lng, severity, report_Date,report_User, img_Url) VALUES (3,3, 'Murray Ave',2112, 15217, 'PA','Pittsburgh', 'USA', '12/25/2018','Repared', 40.433946, -79.9232, 3, '12/25/2018','Lise', 'http://i.imgur.com/4jA5PpN.jpg');  
