...
//				userName, hashedPassword, saltString);
		String sqlInsertStatement = "INSERT INTO app_user (user_name, password, is_employee) VALUES (?, ?, ?);";
		jdbcTemplate.update(sqlInsertStatement, userName, password, isEmployee);
