	...
	<div class="row">
		...
		<div class="col-sm-4">
			<div class="form-group">
				...
				<input type="number" id="lat" name="lat" placeHolder="Latitude" class="form-control" step="any"/>
				<input type="number" id="lng" name="lng" placeHolder="Longitude" class="form-control" step="any"/>
			</div>
			<div class="form-group">
