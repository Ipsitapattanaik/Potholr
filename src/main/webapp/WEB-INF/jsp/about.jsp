...
<a href="${CaitieZajkoLinkedIn}"><img src="${CaitieZajkoPicture}" class="img-fluid" style="height: 100px;" /></a>
...
<a href="${TomAndersonLinkedIn}"><img src="${TomAndersonPicture}" class="img-fluid" style="height: 100px;" /></a>
